...
cvar_t	*r_ps_sharpen;
cvar_t	*r_ps_post_color;
cvar_t	*r_ps_post_color_r;
cvar_t	*r_ps_post_color_g;
cvar_t	*r_ps_post_color_b;
cvar_t	*r_ps_grunge;
...
static void R_Register( void )
{
	...
	r_ps_post_color = ri.Cvar_Get( "r_ps_post_color", "0.0", CVAR_ARCHIVE_ND );
	r_ps_post_color_r = ri.Cvar_Get( "r_ps_post_color_r", "1.0", CVAR_ARCHIVE_ND );
	r_ps_post_color_g = ri.Cvar_Get( "r_ps_post_color_g", "1.0", CVAR_ARCHIVE_ND );
	r_ps_post_color_b = ri.Cvar_Get( "r_ps_post_color_b", "1.0", CVAR_ARCHIVE_ND );
	...
	r_ps_blur_dir = ri.Cvar_Get( "r_ps_blur_dir", "0.0", CVAR_ARCHIVE_ND );
